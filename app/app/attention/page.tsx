...
export default async function AttentionPage() {
  ...
  const [actions, cases, deadJobs, connections, policy, resumeEndpoint] = await Promise.all([
  ...
  return <div className="mx-auto max-w-[980px] px-4 pb-20 pt-7 sm:px-6 lg:px-8">
    ...
    <div className="mt-4"><PageHeader eyebrow="Operations" title="All attention" description="Every approval, recovery, uncertain action, and failed delivery that needs a response." /></div>

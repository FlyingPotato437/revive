  ...
  return <main className="min-h-[100dvh] bg-[#eef0eb] text-[#151922]">
    <div className="mx-auto flex min-h-[100dvh] max-w-[1180px] flex-col px-5 py-6 sm:px-8 sm:py-9">
      <header className="flex items-center justify-between border-b border-[#151922] pb-5">
        <Link href="/" className="flex items-center gap-3"><span className="revive-mark" aria-hidden><span className="revive-mark-ring" /><span className="revive-mark-core" /></span><span className="text-[15px] font-semibold tracking-[-.035em]">Revive Actions</span></Link>
